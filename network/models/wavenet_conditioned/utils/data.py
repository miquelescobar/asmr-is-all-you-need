...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(f'getitem has shape {encoded_audio.shape}')
...
# Important shuffle = False for current implementation of training conditioned network
    ...
    def _collate_fn(self, audio):
        ...
        if self.sample_size:
            ...
            while sample_size > self.receptive_fields:
                ...
                # print(f'collated audio shape {audio.shape}')
